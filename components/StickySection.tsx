...
const StickySection = () => {
  ...
  useEffect(() => {
    ...
    if (!stickySection || !logo || !cubesContainer || !header1 || !header2) return;
    ...
    <section ref={stickySectionRef} className="sticky">
      ...
      <div ref={header2Ref} className="header-2">
        ...
        <p>
          ...
          seamlessly to transform challenges into opportunities. Together, we deliver tailored solutions that
