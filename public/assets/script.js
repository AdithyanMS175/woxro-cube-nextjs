import { cubesData } from "./cubesData.js"; // Added .js extension
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  cubesFaces.forEach((face) => {
    ...
    imageCounter++;
    // Reset counter if you have fewer than 36 images (6 cubes * 6 faces)
  ...
  ScrollTrigger.create({
    ...
    onUpdate: (self) => {
      ...
      const secondPhaseProgress =
        self.progress >= 0.5 ? (self.progress - 0.5) * 2 : 0; // Fixed spelling
      ...
      Object.entries(cubesData).forEach(([cubeClass, data]) => {
        ...
        const currentZ = interpolate(initial.z, final.z, firstPhaseProgress); // Fixed spelling
